...
static const char *strMainNetDNSSeed[][2] = {
    {"seeds.bcoins.net", "seeds.bcoins.net"},
    {"seeds.classiccoinops.com", "seeds.classiccoinops.com"},
    {"seeds.bitcoineasy.info", "seeds.bitcoineasy.info"},
    {NULL, NULL}
};
