...
#ifndef H_STASHCOIN_SCRIPT
#define H_STASHCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CStashcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Stashcoin always counted CHECKMULTISIGs
