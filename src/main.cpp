...
uint256 hashGenesisBlock("0x00000000a97c6ebf1021e8d495e96e0e6f0057fa1f328c8bc8be35a6f4c908ff");
// GB-block 00000000a97c6ebf1021e8d495e96e0e6f0057fa1f328c8bc8be35a6f4c908ff
// GB-nonce 1012821645
...
const string strMessageMagic = "Stashcoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uSTA
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 STA if made of 50 STA inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
        ...
        if (fTestNet) {
            ...
            if (pindexLast->nHeight+1 >= 26754) { DiffMode = 2; }  //stashcoin, 
        }
...
void ThreadScriptCheck() {
    RenameThread("stashcoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000a97c6ebf1021e8d495e96e0e6f0057fa1f328c8bc8be35a6f4c908ff");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045EF23119D05A47FCC4F773173B9DF415B5D5D9C6BBA16BBC1A1F2E34883E365A01A44680295D7CEF8E1EB8031C4CE3AC84AD67F41D3FF989458DB26252B448E1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1394003865;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 1012821645;
        ...
        assert(block.hashMerkleRoot == uint256("0x9de24d6763ac0fd88a7b4d89f9084732869c7727b5b791909dd7a0824bd479b5"));
...
unsigned char pchMessageStart[4] = { 0xf9, 0xbe, 0xb4, 0x3d };
...
void GenerateStashcoins(bool fGenerate, CWallet* pwallet)
{
